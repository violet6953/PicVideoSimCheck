; =============================================================================
; PicSimProcess GPU Installer Script for Inno Setup 7.x
;
; Includes: PyTorch + CUDA + torchvision (full GPU acceleration)
; Result: Fully offline GPU-accelerated image/video similarity tool
;
; Prerequisites:
;   1. Install Inno Setup 7: https://jrsoftware.org/isdl.php
;   2. Run PyInstaller first: python build\build-gpu.py
...
;
; Output: Output\PicSimProcess_GPU_Setup_v{VERSION}.exe
; =============================================================================
...
VersionInfoDescription=Image and Video Similarity Detection Tool (GPU Edition)
...
[Files]
; Main executable
Source: "..\dist-gpu\PicSimProcess\{#AppExeName}"; DestDir: "{app}"; Flags: ignoreversion

; PyInstaller _internal folder (binaries, Python runtime, bundled packages)
Source: "..\dist-gpu\PicSimProcess\_internal\*"; DestDir: "{app}\_internal"; Flags: ignoreversion recursesubdirs createallsubdirs
